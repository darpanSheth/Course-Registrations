    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Front End Development Basics", "CS01", "For mastering front end Web Development basics." });

            migrationBuilder.InsertData(
                table: "Students",
                columns: new[] { "StudentId", "EmailAddress", "FirstName", "LastName", "PhoneNumber" },
                values: new object[] { 1, "devganan34@gmail.com", "Dev", "Ganan", "123-344-2222" });

            migrationBuilder.InsertData(
                table: "Instructors",
                columns: new[] { "InstructorId", "CourseId", "EmailAddress", "FirstName", "LastName" },
                values: new object[] { 1, 1, "harshpatel23@gmail.com", "Harsh", "Patel" });
