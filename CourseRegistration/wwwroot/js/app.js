...
function handleCreateStudent(e) {
    ...
    var studentLastName = document.getElementById("LastName");
    var studentPhoneNumber = document.getElementById("PhoneNumber");
...
function handleCreateInstructor(e) {
    var instructorFirstName = document.getElementById("FirstName");
    var instructorLastName = document.getElementById("LastName");
    var instructorCourseId = document.getElementById("CourseId");
